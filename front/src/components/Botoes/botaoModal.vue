<template>
    <div>
        ...
        <b-modal v-model="modalShow">
            <h4 v-if="pix">PIX: giovanaveiga08@gmail.com</h4>
            <h6>Muito obrigado por abençoar nossas vidas com seu presente, deixe o seu email para que possamos te agradecer!
            </h6>
            ...
            <p v-if="mercadoPago">Mercado pago é um meio de pagamento totalmente seguro, onde você tem opção de parcelar seu
                presente caso queira</p>
        ...
        async enviarPresent() {
            ...
            if (this.formPresent.nome == '' || this.formPresent.email == '') {
                ...
                try {
                    ...
                    sendPresentService.sendRequisition('/present', this.formPresent)
